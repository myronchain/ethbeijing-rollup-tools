...
var (
	...
	LogLevel           = Get("LOG_LEVEL", "info", "upper log level to restrict log output to (dbug, info, warn, error, crit)")
	LogFormat          = Get("LOG_FORMAT", "condensed", "log format (logfmt, condensed, json)")
